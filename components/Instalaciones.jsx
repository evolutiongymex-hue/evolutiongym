    ...
    <section ref={sectionRef} className="py-24 px-4" id="instalaciones">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mt-12">
          <button className="inline-flex items-center gap-2 px-6 py-3 bg-transparent border border-primary rounded-lg text-primary font-semibold hover:bg-primary/10 transition-all duration-300 hover:scale-105">
            <svg
              className="w-5 h-5"
              fill="none"
              stroke="currentColor"
          ...
          <p className="text-gray-500 text-xs mt-4">
            ...
            <span className="text-primary">@evolutiongym</span>
          </p>
        </div>
      </div>
